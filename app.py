...
try:
    DATABASE_URL = st.secrets["postgresql://postgres:PMf3N6nx2UaHs6mn@db.wrrjtmczlwgvilakdtbi.supabase.co:5432/postgres"]
except:
    st.error("❌ Chưa cấu hình DATABASE_URL trong secrets")
    st.stop()
